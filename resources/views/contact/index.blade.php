                    ...
                    <div class="bg-white rounded-xl shadow-sm p-6 space-y-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    <h3 class="text-sm font-semibold text-gray-900">Physical Office Address</h3>
                                    <p class="text-xs text-gray-600 leading-relaxed">MABUDI-DADIN-KOWA ROAD, Opposite the INEC Office, Zamko Road, Mabudi, Plateau State, Nigeria.</p>
                                    <p class="text-xs text-gray-400 mt-1">Official Postal Address: <strong>941107</strong></p>
                                </div>
                            </div>
                            {{-- Email --}}
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    <h3 class="text-sm font-semibold text-gray-900">Official Email Address</h3>
                                    <a href="mailto:langtangsouthlgc@gmail.com" class="text-xs text-primary-green font-semibold hover:underline">langtangsouthlgc@gmail.com</a>
                                </div>
                            </div>
                            {{-- Phone --}}
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    <h3 class="text-sm font-semibold text-gray-900">Official Telephone Number</h3>
                                    <a href="tel:07084219704" class="text-xs text-gray-700 font-semibold hover:underline">07084219704</a>
                                </div>
                            </div>
                        </div>
                    </div>
