    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
                <div class="flex items-center space-x-3 mb-4">
                    <div class="w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-xs">
                        <span class="text-primary-green font-heading font-bold text-lg">LS</span>
                    </div>
                    <span class="font-heading font-bold text-lg">Langtang South Council</span>
                </div>
                <p class="text-green-100 text-sm leading-relaxed">
                    The official website of Langtang South Local Government Council, dedicated to serving
                    the people of Langtang South and promoting transparency, accountability, and development.
                </p>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm">
                    <li class="flex items-start space-x-2">
                        ...
                        <span class="text-green-100 text-xs leading-relaxed">MABUDI-DADIN-KOWA ROAD, Opposite the INEC Office, Zamko Road, Mabudi, Plateau State, Nigeria (Postal: 941107)</span>
                    </li>
                    <li class="flex items-center space-x-2">
                        ...
                        <a href="tel:07084219704" class="text-green-100 text-xs hover:text-white transition-colors duration-200">07084219704</a>
                    </li>
                    <li class="flex items-center space-x-2">
                        <svg class="w-5 h-5 text-gold-accent flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
                        </svg>
                        <a href="mailto:langtangsouthlgc@gmail.com" class="text-green-100 text-xs hover:text-white transition-colors duration-200">langtangsouthlgc@gmail.com</a>
                    </li>
                </ul>
            </div>
            ...
            <div>
                ...
                <div class="flex space-x-3">
                    <a href="#" aria-label="Facebook" class="w-9 h-9 bg-white/10 rounded-full flex items-center justify-center hover:bg-gold-accent hover:text-gray-900 transition-colors duration-200">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                    </a>
                    <a href="#" aria-label="Twitter" class="w-9 h-9 bg-white/10 rounded-full flex items-center justify-center hover:bg-gold-accent hover:text-gray-900 transition-colors duration-200">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                    </a>
                    <a href="#" aria-label="Instagram" class="w-9 h-9 bg-white/10 rounded-full flex items-center justify-center hover:bg-gold-accent hover:text-gray-900 transition-colors duration-200">
        ...
        <div class="mt-10 pt-6 border-t border-green-700">
            <p class="text-center text-sm text-green-200">
                &copy; {{ date('Y') }} Langtang South Local Government Council. All rights reserved.
            </p>
        </div>
    </div>
</footer>
